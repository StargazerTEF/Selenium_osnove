...
public class TablePage extends BasicPage{
    ...
    public String getFirstNameColumnValue (int rowIndex) {
        return driver.findElements(By.cssSelector("tbody tr td:nth-child(2)")).get(rowIndex).getText();
    }
    public String getLastNameColumnValue (int rowIndex) {
        return driver.findElements(By.cssSelector("tbody tr td:nth-child(3)")).get(rowIndex).getText();
    }
    public String getMiddleNameColumnValue (int rowIndex) {
        return driver.findElements(By.cssSelector("tbody tr td:nth-child(4)")).get(rowIndex).getText();
    }
